...
- [ ] `CourseDetailPage` — معلومات تفصيلية عن المقرر
- [ ] صورة المقرر + وصف + معلم + تقدم
- [ ] قائمة الأقسام مع عدادات الإنجاز
- [ ] زر التسجيل/إلغاء التسجيل (للمدير)
- [ ] تقييم المقرر (نجوم)

#### 2.2 عارض الفيديو
- [ ] ```ChewieVideoPlayer``` — مشغل فيديو متكامل
- [ ] تحكم كامل (تشغيل/إيقاف/تقديم/سرعة)
- [ ] ملء الشاشة (Landscape + Portrait)
- [ ] تتبع نقطة التوقف (resume)
- [ ] دعم التنسيقات (MP4, WebM, HLS)

#### 2.3 عارض PDF
- [ ] ```PdfViewerPage``` — عرض ملفات PDF
- [ ] تكبير/تصغير، تنقل بين الصفحات
- [ ] وضع الليل
- [ ] بحث في النص

#### 2.4 عارض HTML/Page
- [ ] ```HtmlContentPage``` — عرض محتوى HTML
...
#### 2.6 عارض H5P
- [ ] ```H5PPlayerPage``` — تشغيل محتوى H5P
- [ ] WebView مع تتبع النتائج
- [ ] دعم أنواع H5P الشائعة
