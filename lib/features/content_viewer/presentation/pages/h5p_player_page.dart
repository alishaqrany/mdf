...
class _H5pPlayerPageState extends State<H5pPlayerPage> {
  ...
  /// Build the H5P player URL and load with Moodle auto-login.
  Future<void> _loadH5PWithAuth() async {
    try {
      ...
      if (widget.url != null && widget.url!.isNotEmpty) {
        ...
        targetUrl = '$baseUrl/mod/h5pactivity/view.php?id=${widget.instance}';
      } else {
        if (mounted) {
          setState(() {
            _hasError = true;
            _errorMessage = 'H5P content URL not available';
          });
        }
        return;
      }
