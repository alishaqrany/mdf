...
class observer {
    ...
    public static function on_user_enrolled(\core\event\user_enrolment_created $event): void {
        ...
        gamification_helper::award_points($userid, 10, 'course_enroll',
            "Enrolled in: {$course->fullname}", $courseid);
    }
    ...
    public static function on_course_completed(\core\event\course_completed $event): void {
        ...
        gamification_helper::award_points($userid, 100, 'module_complete',
            "Completed course: {$course->fullname}", $courseid);
    }
    ...
    public static function on_assignment_submitted(\mod_assign\event\assessable_submitted $event): void {
        ...
        gamification_helper::award_points($studentid, 20, 'assignment_submit',
            "Submitted assignment in: {$course->fullname}", $courseid);
    }
    ...
    public static function on_user_graded(\core\event\user_graded $event): void {
        ...
        // Award gamification points for receiving a grade.
        gamification_helper::award_points($userid, 15, 'quiz_complete',
            "Graded in: {$course->fullname}", $courseid);
    }
    ...
    public static function on_forum_post_created(\mod_forum\event\post_created $event): void {
        ...
        // Award gamification points for forum participation.
        gamification_helper::award_points($authorid, 5, 'forum_post',
            "Forum post: {$subject}", (int)$event->objectid);
    }
